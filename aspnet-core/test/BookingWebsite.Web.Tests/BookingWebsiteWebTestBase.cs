...
using BookingWebsite.Models.TokenAuth;
...
{
    public abstract class BookingWebsiteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BookingWebsiteWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BookingWebsiteWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BookingWebsiteDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BookingWebsiteDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BookingWebsiteDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BookingWebsiteDbContext, Task<T>> func)
        {
            T result;
