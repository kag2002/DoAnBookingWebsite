...
@Injectable()
export class LocationManagementServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAllLocations(): Observable<LocationDto[]> {
        let url_ = this.baseUrl + "/api/services/app/LocationManagement/GetAllLocations";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllLocations(response: HttpResponseBase): Observable<LocationDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    addNewLocation(body: LocationDto | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/LocationManagement/AddNewLocation";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    updateLocation(body: LocationDto | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/LocationManagement/UpdateLocation";
        url_ = url_.replace(/[?&]$/, "");
    ...
    deleteLocation(id: number | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/LocationManagement/DeleteLocation?";
        if (id === null)
    ...
    uploadImage(id: number | undefined, path: string | undefined, imageFile: FileParameter | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/LocationManagement/UploadImage?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
...
export class LocationDto implements ILocationDto {
    ...
    locationInfor: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.locationInfor = _data["locationInfor"];
            this.imgName = _data["imgName"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["locationInfor"] = this.locationInfor;
